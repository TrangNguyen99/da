...
if __name__ == '__main__':
    ...
    parser.add_option("--posembedding", type="int", dest="posembedding_dims", default=25)
    ...
    parser.add_option("--dynet-pd", type="int", dest="pembedding_dims", default=0)
    ...
    if options.predictFlag:
        ...
        if not conllu:
            ...
            os.system('python src/utils/evaluation_script/conll17_ud_eval.py -v -w src/utils/evaluation_script/weights.clas ' + options.conll_test + ' ' + tespath + ' > ' + tespath + '.txt')
    else:
